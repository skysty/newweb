		...
		<div class = "content_wrapper" style = "width: 100%; margin: 0 auto; margin-top: 10px;">		
			...
			<div class = "works">
					<?php
						...
						WHERE faculties.FacultyID = '$_GET[ID]' AND tutors.roleID = 5 AND  engbekter.univ_avtor_san IS NULL  AND  engbekter.kod_kafedra IS NULL ORDER BY engbekter.engbekID DESC";
