			...
			if($status == 3){
				...
				if($avtor_san > 1){				
					if($kod_korsetkish == 540){
						...
						$last_ball = $r/$avtor_san;
						echo $last_ball = sprintf("%.2f", $last_ball);
						$sql = mysql_query($connection,"UPDATE engbekter SET ball = '$last_ball', kod_stat = '3' WHERE engbekID = '$engbek_id'") or die(mysqli_error($connection));
						$sql2 = mysql_query($connection,"INSERT INTO tekserushi(kod_tekserushi,kod_korset,kod_fakultet) VALUES('$tutor_moderator','$kod_korsetkish','$kod_fakul')") or die(mysqli_error($connection));
						header('Location: show_conf_ok.php');
						...
						echo $last_ball = sprintf("%.2f", $last_ball);
						$sql = mysqli_query($connection,"UPDATE engbekter SET ball = '$last_ball', kod_stat = '3' WHERE engbekID = '$engbek_id'") or die(mysqli_error($connection));
						$sql2 = mysql_query($connection,"INSERT INTO tekserushi(kod_tekserushi,kod_korset,kod_fakultet) VALUES('$tutor_moderator','$kod_korsetkish','$kod_fakul')") or die(mysql_error());
						header('Location: show_conf_ok.php');
					} else {
					...
					if($kod_korsetkish == 540){
						...
						$last_ball = $r;
						echo $last_ball = sprintf("%.2f", $last_ball);
						$sql = mysqli_query($connection,"UPDATE engbekter SET ball = '$last_ball', kod_stat = '3' WHERE engbekID = '$engbek_id'") or die(mysql_error());
						$sql2 = mysqli_query($connection,"INSERT INTO tekserushi(kod_tekserushi,kod_korset,kod_fakultet) VALUES('$tutor_moderator','$kod_korsetkish','$kod_fakul')") or die(mysqli_error($connection));
						header('Location: show_conf_ok.php');
					} else if($kod_korsetkish == 560){
						$s = $sani * 0.002*3;
						...
						$last_ball = $s;
						echo $last_ball = sprintf("%.2f", $last_ball);
						$sql = mysqli_query("UPDATE engbekter SET ball = '$last_ball', kod_stat = '3' WHERE engbekID = '$engbek_id'") or die(mysqli_error($connection));
						...
						$last_ball = $s;
						echo $last_ball = sprintf("%.2f", $last_ball);
						$sql = mysql_query("UPDATE engbekter SET ball = '$last_ball', kod_stat = '3' WHERE engbekID = '$engbek_id'") or die(mysqli_error($connection));
						$sql2 = mysql_query("INSERT INTO tekserushi(kod_tekserushi,kod_korset,kod_fakultet) VALUES('$tutor_moderator','$kod_korsetkish','$kod_fakul')") or die(mysqli_error($connection));
						header('Location: show_conf_ok.php');
