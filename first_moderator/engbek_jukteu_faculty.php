	...
	<div class = "content">
		<div class = "content_wrapper" style = "margin-top: 5px;">
			<div class = "inner_conten" style = "width: 1000px; margin: 0 auto;">
				<h2 style = "text-align: center;">Орталықтандырылған ендіру (Факультет немесе ҒЗО)</h2>			
				<?php
				...
				*/
					...
					function load_korsetkish(){
						...
						global $connection;
						$output = '';
						$sql = "SELECT * FROM korsetkishter WHERE bolimderID IN (3) and typeID='$tt'";
				...
				<div class = "works">
					...
					<?php
						...
						echo "<table><tr><th>№</th><th>Факультет/Кафедра</th><th>Аты жөні</th><th>Көрсеткіш</th><th>Саны</th><th>Автор саны</th><th>Файл аты</th><th>Балл</th><th>Қайтару себебі</th><th>Статус</th></tr>";
