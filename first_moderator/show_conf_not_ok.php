...
?>
	...
	<div class = "content">
		<div class = "content_wrapper" style = "width: 100%; margin: 0 auto; margin-top: 5px;">	
			<h2 style = "text-align: center; padding-top: 10px;"><span style = "color: red;">[</span>Оқытушы еңбегі қайтарылды!!!<span style = "color: red;">]</span></h2>
			<?php
			
				$_SESSION['tutor'];
				echo "<script>setTimeout('window.close()',2000)</script>";
				//$query = mysqli_query($connection,"SELECT * FROM teachers WHERE login = '$_SESSION[teacher]'") or die(mysqli_error($connection));
