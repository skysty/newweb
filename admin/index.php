		...
		<nav id="primary_nav_wrap">
			<ul>
			  <li><a href="#">Негізгі</a>
				<ul>
				  <li>
					  <a href="index.php">Негізгі бет</a></li>
                      <!--<li><a href="main.php">Ғылыми дәреже</a></li>-->
                      <li><a href="tekseruler.php">Еңбектерді тексеру</a></li>
				  ...
				  <li>
					  <a href="#">Құжаттар</a>                      
				       ...
				       <ul>				     
							...
							<li><a href="enbek_filter.php">Фильтр</a></li>
