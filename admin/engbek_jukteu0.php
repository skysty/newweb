			...
			<div class = "inner_conten" style = "width: 1000px; margin: 0 auto;">
				...
				*/
					...
					function load_korsetkish(){
						...
						while($row = mysql_fetch_array($result)){			
							$output .= '<option id_esep="'.$row["id_esep"].'" id_comment="'.$row["id_comment"].'" value = "'.$row["kod_korsetkish"].'">' . $row["korsetkish_ati"] . '</option>';				
						}
						return $output;
					}
				?>
				...
				<div class = "select_box">
					<form method = "post" action = "load_engbek.php" style = "margin-top: 10px;" enctype = "multipart/form-data">
						Көрсеткіштер
