<?php
	...
	if(isset($_POST['upload'])){
		...
		if($file_size == FALSE){
			echo "<span style = 'color: red;'>Тым үлкен файл</span>";
		} else {
			...
			if($b < $a){
				...
				$query = mysqi_query("INSERT INTO engbekter(kod_korset, kod_kizm, kod_okujil, kod_univer, kod_fakul, kod_kafedra, sani, kuni,  file_ati, rastalu, univ_avtor_san, ball, eskertu, kod_stat, artik, ball8, saktalgan_kuni) VALUES('$korsetkish','$TutorID','11','1','$FacultyID','$cafedraID','$sani','$date','../files/$newfilename','-','$univ_avtor_san','0','$eskertu','2','0','0','$save_date')") or die(mysql_error());
