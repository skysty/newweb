...
<body>
	...
	<div class = "content">
		<div class = "content_wrapper" style = "margin-top: 5px;">					
			...
			*/
				$_SESSION['tutor'];
				$query = mysqli_query($connection,"SELECT * FROM tutors WHERE Login = '$_SESSION[tutor]'") or die(mysql_error());
			...
			<?php				
$sql1 = mysqli_query($connection,"SELECT korsetkishter.korsetkish_ati, faculties.facultyNameKZ, SUM( engbekter.ball ) AS sum_val
FROM engbekter
...
$sql12 = mysqli_query($connection,"SELECT korsetkishter.korsetkish_ati, cafedras.cafedraNameKZ, SUM( engbekter.ball ) AS sum_val
FROM engbekter
INNER JOIN korsetkishter ON korsetkishter.kod_korsetkish = engbekter.kod_korset
