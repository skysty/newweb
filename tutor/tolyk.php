	...
	<div class = "content">
		...
		<div class = "content_wrapper" style = "width: 100%; margin: 0 auto; margin-top: 10px;">
			...
			<?php
					...
					WHERE TutorID = '$_GET[ID]' and engbekter.del=0 ") or die(mysqli_error());
					...
					$sql4 = mysqli_query($connection,"SELECT engbekter.engbekID, SUM(engbekter.ball)*0.35 AS sum_oku, SUM(engbekter.ball) AS sum_oku1,engbekter.file_ati, engbekter.sani, engbekter.univ_avtor_san, engbekter.eskertu, engbekter.ball, tutors.TutorID, tutors.lastname, tutors.firstname, tutors.patronymic, faculties.facultyNameKZ, cafedras.cafedraNameKZ, korsetkishter.korsetkish_ati, status.status_name, kaytaru_sebebi.sebepter, korsetkishter.typeID
					...
					WHERE TutorID = '$_GET[ID]' AND korsetkishter.typeID = 2 and engbekter.del=0") or die(mysql_error());
					...
					$sql5 = mysqli_query($connection,"SELECT engbekter.engbekID, SUM(engbekter.ball)*0.15 AS sum_tarbie,SUM(engbekter.ball) AS sum_tarbie1, engbekter.file_ati, engbekter.sani, engbekter.univ_avtor_san, engbekter.eskertu, engbekter.ball, tutors.TutorID, tutors.lastname, tutors.firstname, tutors.patronymic, faculties.facultyNameKZ, cafedras.cafedraNameKZ, korsetkishter.korsetkish_ati, status.status_name, kaytaru_sebebi.sebepter, korsetkishter.typeID
					...
					WHERE TutorID = '$_GET[ID]' AND engbekter.kod_korset=129 and engbekter.del=0") or die(mysqli_error($connection));
					...
					<table style = "font-size: 19px;">
						...
						<tr>
							...
							<td>
							  ...
							  <strong>Әлеуметтік-мәдени бағыты:15%</strong>
