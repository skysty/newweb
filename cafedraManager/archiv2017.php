...
?>
	...
	<div class = "content">
		<div class = "content_wrapper" style = "margin-top: 5px;margin-bottom: 10px;">
			<h3 align = "center">Рейтинг ОПҚ 2016-2017 маусым<br /> ИНДИКАТИВТІ ЖОСПАРЫ</h3>
			<object data="../files/ОПК_рейтинги_2016-2017.PDF" type="application/pdf" width="100%" height="600px">
			</object>
		</div>
	</div>
</body>
