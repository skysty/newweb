...
?>
	...
	<div class = "content">
		<div class = "content_wrapper" style = "margin-top: 5px;margin-bottom: 10px;">
			<h3 align = "center">Рейтинг ОПҚ 2014-2015 маусым<br /> ИНДИКАТИВТІ ЖОСПАРЫ</h3>
			<object data="../files/РейтингОПК2014-2015июнь.pdf" type="application/pdf" width="100%" height="600px">
			</object>
		</div>
	</div>
</body>
