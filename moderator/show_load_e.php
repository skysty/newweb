...
?>
	...
	<div class = "content">
		<div class = "content_wrapper" style = "width: 100%; margin: 0 auto; margin-top: 5px;">	
			<h2 style = "text-align: center; padding-top: 10px;"><span style = "color: red;">[</span>Оқытушы еңбегі сәтті тексерілді!!!<span style = "color: red;">]</span></h2>
			<?php
			
				$_SESSION['tutor'];
				header("refresh:2; url=engbek_tekseru.php");
