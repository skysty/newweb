...
/*	$sql = "SELECT * FROM state WHERE countryID = '".$_POST["countryID"]."' AND stateID = '".$_POST["stateID"]."'";
	...
	$result3 = mysqli_query($connection,$sql3) or die(mysql_error($connection));
	
	$result4 = mysqli_query($connection,$sql4) or die(mysql_error($connection));
	
	$result5 = mysqli_query($connection, $sql5) or die(mysql_error($connection));
