...
?>
	...
	<div class = "content">
		<div class = "content_wrapper" style = "margin-top: 5px;margin-bottom: 10px;">
			<h3 align = "center">Ахмет Ясауи университеті факультеттерінің 2017-2018 оқу жылына<br /> ИНДИКАТИВТІ ЖОСПАРЫ</h3>
			<object data="../files/Jospar_2017_2018.pdf" type="application/pdf" width="100%" height="600px">
